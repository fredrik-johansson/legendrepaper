...
We give some elements of comparison between Gauss-Legendre quadrature and
alternative methods,  such as Clenshaw-Curtis quadrature, in
\cref{sec:vsothers}.
...
As discussed in \cref{sec:bitburst} below, an approach based on the
``bit-burst'' evaluation method for hypergeometric series
leads to a similar complexity bound and may prove more practical
for extremely large~$p$, but likely not for~$p \leq 10^6$.
...
the asymptotic expansion gives a candidate algorithm for all but about
$(\log(2)/\pi)\,p/n$ of the nodes as $p/n \to 0$.
...
in~\cite[Corollaries 1~and~2]{brent2016asymptotic}.
...
\bibitem{AntonovHolsevnikov1981}
{\sc V.~Antonov and K.~Holševnikov}, {\em An estimate of the remainder in the
  expansion of the generating function for the {L}egendre polynomials
  (generalization and improvement of {B}ernstein's inequality)}, Vestnik
  Leningrad Univ. Mat., 13 (1981), pp.~163--166.
\newblock English translation of~\cite{AntonovHolsevnikov1980} by
  \textsc{H.~H.~McFadden}.

\bibitem{bailey2011high}
{\sc D.~H. Bailey and J.~M. Borwein}, {\em High-precision numerical
  integration: Progress and challenges}, J. Symbolic Comput., 46 (2011),
  pp.~741--754, \url{http://dx.doi.org/10.1016/j.jsc.2010.08.010}.

\bibitem{BaileyBorweinCrandall2006}
{\sc D.~H. Bailey, J.~M. Borwein, and R.~E. Crandall}, {\em Integrals of the
  {{Ising}} class}, J. Phys. A, 39 (2006), p.~12271,
  \url{http://dx.doi.org/10.1088/0305-4470/39/40/001}.

\bibitem{bailey2002arprec}
{\sc D.~H. Bailey, H.~Yozo, X.~S. Li, and B.~Thompson}, {\em {ARPREC}: An
  arbitrary precision computation package}, 2002.

\bibitem{bogaert2014iteration}
{\sc I.~Bogaert}, {\em Iteration-free computation of {G}auss--{L}egendre
  quadrature nodes and weights}, SIAM J. Sci. Comput., 36 (2014),
  pp.~A1008--A1026, \url{http://dx.doi.org/10.1137/140954969}.

\bibitem{Bogaert2012}
{\sc I.~Bogaert, B.~Michiels, and J.~Fostier}, {\em O(1) computation of
  {L}egendre polynomials and {G}auss--{L}egendre nodes and weights for parallel
  computing}, SIAM J. Sci. Comput., 34 (2012), pp.~C83--C101,
  \url{http://dx.doi.org/10.1137/110855442}.

\bibitem{brent2016asymptotic}
{\sc R.~P. Brent}, {\em Asymptotic approximation of central binomial
  coefficients with rigorous error bounds}, 2016,
  \url{http://arxiv.org/abs/1608.04834}.

\bibitem{BrentZimmermann2010}
{\sc R.~P. Brent and P.~Zimmermann}, {\em Modern Computer Arithmetic},
  Cambridge University Press, 2010,
  \url{http://www.loria.fr/~zimmerma/mca/mca-cup-0.5.7.pdf}.

\bibitem{Broadhurst2016}
{\sc D.~Broadhurst}, {\em Feynman integrals, {L}-series and {K}loosterman
  moments}, Feb. 2016, \url{http://arxiv.org/abs/1604.03057}.

\bibitem{ChowGatteschiWong1994}
{\sc Y.~Chow, L.~Gatteschi, and R.~Wong}, {\em A {B}ernstein-type inequality
  for the {J}acobi polynomial}, Proc. Amer. Math. Soc., 121 (1994),
  pp.~703--709, \url{http://dx.doi.org/10.2307/2160265}.

\bibitem{ChudnovskyChudnovsky1990}
{\sc D.~V. Chudnovsky and G.~V. Chudnovsky}, {\em Computer algebra in the
  service of mathematical physics and number theory}, in Computers in
  Mathematics, D.~V. Chudnovsky and R.~D. Jenks, eds., vol.~125 of Lecture
  Notes in Pure and Applied Mathematics, Dekker, 1990, pp.~109--232.
\newblock Talks from the International Conference on Computers and Mathematics,
  Stanford University, 1986.

\bibitem{fousse2007accurate}
{\sc L.~Fousse}, {\em Accurate multiple-precision {G}auss--{L}egendre
  quadrature}, in 18th IEEE Symposium on Computer Arithmetic, ARITH'07, IEEE,
  2007, pp.~150--160.

\bibitem{golub1969calculation}
{\sc G.~H. Golub and J.~H. Welsch}, {\em Calculation of {G}auss quadrature
  rules}, Math. Comp., 23 (1969), pp.~221--230,
  \url{http://dx.doi.org/10.1007/BF01389877}.

\bibitem{granlund2017}
{\sc T.~Granlund and {the GMP development team}}, {\em {GNU MP}: {T}he {GNU}
  {M}ultiple {P}recision {A}rithmetic {L}ibrary}, 6.1.2~ed., 2017,
  \url{https://gmplib.org/}.

\bibitem{hale2013fast}
{\sc N.~Hale and A.~Townsend}, {\em Fast and accurate computation of
  {G}auss--{L}egendre and {G}auss--{J}acobi quadrature nodes and weights}, SIAM
  J. Sci. Comput., 35 (2013), pp.~A652--A674,
  \url{http://dx.doi.org/10.1137/120889873}.

\bibitem{Johansson2014rectangular}
{\sc F.~Johansson}, {\em Evaluating parametric holonomic sequences using
  rectangular splitting}, in Proceedings of the 39th International Symposium on
  Symbolic and Algebraic Computation, ISSAC '14, New York, NY, USA, 2014, ACM,
  pp.~256--263, \url{http://dx.doi.org/10.1145/2608628.2608629}.

\bibitem{Johansson2015elementary}
{\sc F.~Johansson}, {\em Efficient implementation of elementary functions in
  the medium-precision range}, in 22nd IEEE Symposium on Computer Arithmetic,
  ARITH22, 2015, pp.~83--89, \url{http://dx.doi.org/10.1109/ARITH.2015.16}.

\bibitem{johansson2016hypergeometric}
{\sc F.~Johansson}, {\em Computing hypergeometric functions rigorously}, 2016,
  \url{http://arxiv.org/abs/1606.06977}.

\bibitem{Johansson2017arb}
{\sc F.~Johansson}, {\em Arb: efficient arbitrary-precision midpoint-radius
  interval arithmetic}, IEEE Trans. Comput., 66 (2017), pp.~1281--1292,
  \url{http://dx.doi.org/10.1109/TC.2017.2690633}.

\bibitem{Johansson2018a}
{\sc F.~Johansson and I.~V. Blagouchine}, {\em Computing {Stieltjes} constants
  using complex integration}, June 2018, \url{http://arxiv.org/abs/1804.01679}.

\bibitem{kobel2013fast}
{\sc A.~Kobel and M.~Sagraloff}, {\em Fast approximate polynomial multipoint
  evaluation and applications}, 2013, \url{https://arxiv.org/abs/1304.8069}.

\bibitem{kowalski1985gauss}
{\sc M.~A. Kowalski, A.~G. Werschulz, and H.~Wo{\'z}niakowski}, {\em Is {G}auss
  quadrature optimal for analytic functions?}, Numer. Math., 47 (1985),
  pp.~89--98.

\bibitem{Molin2010a}
{\sc P.~Molin}, {\em Numerical Integration and {L}-Functions Computations},
  thèse de doctorat, Universit{\'e} Sciences et Technologies -- Bordeaux I, Oct. 2010.

\bibitem{moore1979methods}
{\sc R.~E. Moore}, {\em Methods and applications of interval analysis}, SIAM,
  1979.

\bibitem{Olver1997}
{\sc F.~W.~J. Olver}, {\em Asymptotics and Special Functions}, A K Peters,
  Wellesley, MA, 1997.

\bibitem{Olver2010}
{\sc F.~W.~J. Olver, D.~W. Lozier, R.~F. Boisvert, and C.~W. Clark}, {\em {NIST
  Handbook of Mathematical Functions}}, Cambridge University Press, New York,
  2010.

\bibitem{petras1999computation}
{\sc K.~Petras}, {\em On the computation of the {G}auss--{L}egendre quadrature
  formula with a given precision}, J. Comput. Appl. Math., 112 (1999),
  pp.~253--267, \url{http://dx.doi.org/10.1016/S0377-0427(99)00225-3}.

\bibitem{petras2002self}
{\sc K.~Petras}, {\em Self-validating integration and approximation of
  piecewise analytic functions}, J. Comput. Appl. Math., 145 (2002),
  pp.~345--359, \url{http://dx.doi.org/10.1016/S0377-0427(01)00586-6}.

\bibitem{Smith1989}
{\sc D.~M. Smith}, {\em Efficient multiple-precision evaluation of elementary
  functions}, Math. Comp., 52 (1989), pp.~131--134,
  \url{http://myweb.lmu.edu/dmsmith/MComp1989.pdf}.

\bibitem{takahasi1974double}
{\sc H.~Takahasi and M.~Mori}, {\em Double exponential formulas for numerical
  integration}, Publ. Res. Inst. Math. Sci., 9 (1974), pp.~721--741,
  \url{http://dx.doi.org/10.2977/prims/1195192451}.

\bibitem{PARI2}
{\sc {The PARI~Group}}, {\em {PARI/GP version 2.9.4}}, Univ. Bordeaux, 2017,
  \url{http://pari.math.u-bordeaux.fr/}.

\bibitem{townsend2015race}
{\sc A.~Townsend}, {\em The race for high order {G}auss--{L}egendre
  quadrature}, SIAM News,  (2015), pp.~1--3,
  \url{http://math.mit.edu/~ajt/papers/QuadratureEssay.pdf}.

\bibitem{trefethen2008gauss}
{\sc L.~N. Trefethen}, {\em Is {G}auss quadrature better than
  {C}lenshaw--{C}urtis?}, SIAM Rev., 50 (2008), pp.~67--87,
  \url{http://dx.doi.org/10.1137/060659831}.

\bibitem{Trefethen2011}
{\sc L.~N. Trefethen}, {\em Six myths of polynomial interpolation and
  quadrature}, 2011,
  \url{https://people.maths.ox.ac.uk/trefethen/mythspaper.pdf}.

\bibitem{vdH:ball}
{\sc J.~van~der Hoeven}, {\em Ball arithmetic}, tech. report, HAL, 2009,
  \url{http://hal.archives-ouvertes.fr/hal-00432152/fr/}.

\bibitem{Wimp1984}
{\sc J.~Wimp}, {\em Computation with Recurrence Relations}, Pitman, Boston,
  1984.

\bibitem{AntonovHolsevnikov1980}
{\sc {В. А. Антонов and К. В. Холшевников}}, {\em
  Оценка остатка разложения производящей
  функции полиномов {Л}ежандра (обобщение и
  уточнение неравенства {Б}ернштейна)},
  Вестник Ленинградского университета
  (Математика), no. 13 (1980), pp.~5--7.
\newblock English translation in~\cite{AntonovHolsevnikov1981}.
