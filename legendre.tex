...
than the trivial $\widetilde{O}(n^3)$ bound is possible:
...
in~\cite{petras1999computation} together with the interval Newton method.

Our algorithm switches between several methods.
